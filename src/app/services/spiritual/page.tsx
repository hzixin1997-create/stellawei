  ...
  return (
    <div className="min-h-screen bg-cream">
      ...
      <section className="relative pt-32 pb-16 overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-r from-amber-300/20 to-orange-300/20 rounded-full blur-3xl"></div>
