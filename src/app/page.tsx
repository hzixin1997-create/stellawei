        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
              <Button size="lg" className="text-sm sm:text-lg px-6 sm:px-8 w-full sm:w-auto min-w-0" onClick={handleBookingClick}>
                {t('hero.ctaPrimary')}
              </Button>
              <Button 
                variant="outline" 
                size="lg" 
                className="text-sm sm:text-lg px-6 sm:px-8 w-full sm:w-auto min-w-0"
                onClick={() => {
